...
async def my_bookings(request:Request,db:Session = Depends(get_db),curr_user = Depends(get_current_user)):
    ...
    return templates.TemplateResponse('my_bookings.html',{'request':request,'bookings':grouped})
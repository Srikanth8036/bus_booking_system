...
def signin_page(request:Request):
    return templates.TemplateResponse('signup.html',{'request':request,'form_data':{},'errors':{}})
...
async def signin_form(
    ...
    try:
        ...
        if db.query(Users).filter(Users.username==validated_data.username).first() or db.query(Users).filter(Users.email==validated_data.email).first():
